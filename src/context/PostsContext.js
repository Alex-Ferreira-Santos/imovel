...
import casa2 from '../img/casa12.jpg'
...
export function PostProvider(props){
    ...
    const [posts,setPosts] = useState([
        {id:1,title:'Casa de luxo com 5 quartos a venda',price:700000,city:'Rio de Janeiro',state:'Rio de Janeiro',finalidade:'Venda',type:'Casa', adress:'Rua a, 80',description:'Casa com 5 quartos, 2 cozinhas, 2 salas, piscina, jardim e 3 banheiros a venda',image:[{uri:casa1},{uri:casa2},{uri:casa3},{uri:casa4}]},
